...
export default class Slider extends React.Component {
  ...
  getLastStyle() {
    if (!this.state.active) {
      return Object.assign(this.transition.prevEnd(this.state.direction, this.state.viewport.last), this.transition.transition(this.props.transitionTime), style.lastView);
    }
    return Object.assign(this.transition.prevStart(this.state.direction, this.state.viewport.last), style.lastView);
  }
  ...
  render() {
    return React.createElement(
      'div',
      { className: this.props.className, style: style.slider },
      React.createElement(
        'section',
        { style: style.wrapper },
      ...
      React.createElement(
        'section',
        { className: 'slider__dots', style: style.dots },
        this.renderDots()
      )
    );
  }
